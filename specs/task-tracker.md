...
| P8-06 | Concierge | Implement global Concierge assistant | TODO | P8-05 | answers workflow status | Pending |
| P8-07 | Observability | Integrate Langfuse trace export | TODO | P8-06 | trace searchable by workflow_id | Pending |
| P8-08 | Demo | Validate 5-minute end-to-end demo script | TODO | P8-07 | browser E2E passes with final script | Pending |
